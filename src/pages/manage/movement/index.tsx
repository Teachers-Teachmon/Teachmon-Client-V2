...
export default function Movement() {
    ...
    const prefilledStudentDisplay = searchParams.get('studentDisplay');
    ...
    return <MovementForm
        ...
        savedFormData={formData ?? undefined}
        prefilledStudent={prefilledStudentId && prefilledStudentDisplay ? { id: prefilledStudentId, display: prefilledStudentDisplay } : undefined}
    />;
}
